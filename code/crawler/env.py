...
CRAWL_DATA_LVN_DATABASE_URL = env.str("CRAWL_DATA_LVN_DATABASE_URL")


CRAWL_DATA_LVN_NAME = env.str("CRAWL_DATA_LVN_NAME")
CRAWL_DATA_LVN_PASS = env.str("CRAWL_DATA_LVN_PASS")


PATH_FILE_DOCUMENT_LIST = os.path.join(PATH_FOLDER_DATA, "document_list.jsonl")
